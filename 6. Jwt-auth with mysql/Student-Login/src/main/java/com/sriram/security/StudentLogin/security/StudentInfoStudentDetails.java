...
public class StudentInfoStudentDetails implements UserDetails {

    private String email;
    private String password;
    private List<GrantedAuthority> authorities;

    public StudentInfoStudentDetails(StudentInfo studentInfo) {
        this.email=studentInfo.getEmail();
        this.password=studentInfo.getPassword();
        this.authorities= Arrays.stream(studentInfo.getRole().split(","))
